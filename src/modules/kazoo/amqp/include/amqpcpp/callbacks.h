...
using CanceledCallback      =   std::function<void(const std::string &consumer)>;
...
using MessageConsumerCB     =   std::function<void(const Message &message, const std::string &consumerTag, uint64_t deliveryTag, bool redelivered)>;
