...
static param_export_t params[] = {
	...
	{"amqp_connection", PARAM_STRING|PARAM_USE_FUNC,(void*)kz_amqp_add_connection_k},
	{"amqp_max_channels", PARAM_INT, &dbk_channels},

	{"amqp_consumer_processes", PARAM_INT, &dbk_consumer_processes},
	{"amqp_consumer_workers", PARAM_INT, &dbk_consumer_workers},
	...
	{"amqp_query_timeout_micro", PARAM_INT, &kz_qtimeout_tv.tv_usec},
	{"amqp_query_timeout_sec", PARAM_INT, &kz_qtimeout_tv.tv_sec},

	{"pua_mode", PARAM_INT, &dbk_pua_mode},
	{"db_url", PARAM_STR, &kz_db_url},
	{"pua_lock_type", PARAM_INT, &kz_pua_lock_type},
	{"presentity_table", PARAM_STR, &kz_presentity_table},
	{"pua_include_entity", PARAM_INT, &default_kz_presence_cfg.include_entity},
	{"presence_use_full_entity", PARAM_INT, &default_kz_presence_cfg.use_full_entity},

	{"json_escape_char", PARAM_STR, &kz_json_escape_str},

	{"app_name", PARAM_STR, &kz_app_name},

	{"amqp_connect_timeout", PARAM_INT, &dbk_connect_timeout},
	{"amqp_heartbeats", PARAM_INT, &dbk_use_heartbeats},
	...
	{"amqps_verify_peer", PARAM_INT, &kz_amqps_verify_peer},
	{"amqps_verify_hostname", PARAM_INT, &kz_amqps_verify_hostname},

	{"amqp_worker_queue_name_template", PARAM_STR, &dbk_default_worker_name_template},
	{"xavp_status", PARAM_STR, &kz_xavp_status},
	{"enable_clock_diff_warning", PARAM_INT, &kz_enable_clock_diff_warning},
	{"pid_routing_key_header", PARAM_STR, &kz_deliver_to_pid},

	{"amqp_log_level", PARAM_INT, &default_kz_amqp_cfg.log_level},

	{"relay", PARAM_INT, &default_kz_relay_cfg.active},

	{"pua_max_dialoginfo_xml_body_size", PARAM_INT, &default_kz_presence_cfg.max_dialoginfo_xml_body_size},
	{"pua_max_presence_xml_body_size", PARAM_INT, &default_kz_presence_cfg.max_presence_xml_body_size},
	{"pua_max_mwi_xml_body_size", PARAM_INT, &default_kz_presence_cfg.max_mwi_xml_body_size},

	{"sca.db_update_interval", PARAM_INT, &default_kz_sca_cfg.db_update_interval},
	{"sca.hash_table_size", PARAM_INT, &default_kz_sca_cfg.hash_table_size},
	{"sca.call_info_max_expires", PARAM_INT, &default_kz_sca_cfg.call_info_max_expires},
	{"sca.line_seize_max_expires", PARAM_INT, &default_kz_sca_cfg.line_seize_max_expires},
	{"sca.purge_expired_interval", PARAM_INT, &default_kz_sca_cfg.purge_expired_interval},
	{"sca.subs_table", PARAM_STR, &default_kz_sca_cfg.subs_table},
	{"sca.state_table", PARAM_STR, &default_kz_sca_cfg.state_table},
	{"sca.process_no_subscribers", PARAM_INT, &default_kz_sca_cfg.process_no_subscribers},
	...
	{"sca.log_level", PARAM_INT, &default_kz_sca_cfg.log_level},
	{"sca.use_next_available", PARAM_INT, &default_kz_sca_cfg.use_next_available},
