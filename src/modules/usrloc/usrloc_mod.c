...
static param_export_t params[] = {
	...
	{"db_insert_update", PARAM_INT, &ul_db_insert_update},
	{"use_domain", PARAM_INT, &ul_use_domain},
	{"desc_time_order", PARAM_INT, &ul_desc_time_order},
	...
	{"matching_mode", PARAM_INT, &ul_matching_mode},
	{"cseq_delay", PARAM_INT, &ul_cseq_delay},
	{"fetch_rows", PARAM_INT, &ul_fetch_rows},
	{"hash_size", PARAM_INT, &ul_hash_size},
	{"nat_bflag", PARAM_INT, &ul_nat_bflag},
	...
	{"db_ops_ruid", PARAM_INT, &ul_db_ops_ruid},
...
#ifdef STATISTICS
	/* register statistics */
	if(register_module_stats("usrloc", mod_stats) != 0) {
