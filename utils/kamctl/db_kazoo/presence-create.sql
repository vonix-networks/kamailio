CREATE TABLE presentity (
    ...
    body BLOB NOT NULL,
    sender VARCHAR(255) NOT NULL COLLATE NOCASE,
...
CREATE TABLE active_watchers (
    id INTEGER PRIMARY KEY NOT NULL,
    presentity_uri VARCHAR(255) NOT NULL COLLATE NOCASE,
    ...
    from_user VARCHAR(64) NOT NULL COLLATE NOCASE,
    from_domain VARCHAR(64) NOT NULL COLLATE NOCASE,
